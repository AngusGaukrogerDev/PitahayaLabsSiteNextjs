    ...
    return(
        <>
            <section id="home" className="bg-pitahaya-light-grey w-full h-screen flex flex-col justify-center items-center">
                ...
                <div className="h-screen w-full xl:w-2/3 px-5 md:px-28 lg:px-32 xl:px-44 gap-3 xl:gap-7 flex flex-col justify-center items-center text-center sm:text-center sm:items-center">
                    <h1 className="text-pitahaya-black hidden">Software Development Services for EdTech Start-ups</h1>
                    <h2 className="text-pitahaya-black text-4xl lg:text-5xl xl:text-6xl">Software Development Services for EdTech Start-ups</h2>
                    <h3 className="text-pitahaya-black w-10/12 ">We specialise in building bespoke learning platforms for E-Learning Start-ups, harnessing modern technologies and AI.</h3>
