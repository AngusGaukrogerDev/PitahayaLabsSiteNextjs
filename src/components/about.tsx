...
const About = () => {
    return(
        <section className="w-full about-overflow text-center  flex flex-col justify-start items-center  px-5 gap-5 bg-snow-900">
            <h2 className="text-gunmetal-300 mt-10">Building a Learning Platform <br className="block sm:hidden"/>shouldn’t be hard. <br className="block sm:hidden"/>Let’s craft an app that<br className="block sm:hidden"/> your students will love!</h2>
            <div className=" h-auto rounded-lg mb-5 px-1 py-4 text-center flex flex-col justify-center items-center gap-3">
                <h3 className="text-gunmetal-500 w-68">
                ...
                <Link legacyBehavior href="/#service" as="/#service">
                    <button className="flex flex-row justify-center items-center gap-2 hover:cursor-pointer">
                        <h3 className="text-amaranth-500">
                            Find out how
                        </h3>
