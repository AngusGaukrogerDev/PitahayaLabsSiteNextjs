...
const ServicesTile: React.FC<ServicesTileProps> = ({ number, title, description }) => {
  return (
    <div className="bg-pitahaya-white border-pitahaya-yellow  w-10/12 sm:w-2/3 md:w-1/2 xl:w-2/4 services-card-height-md flex flex-col justify-center xl:justify-center items-center px-5 xl:px-2 py-10 xl:py-2 rounded-md text-center gap-5 xl:gap-2 ">
      <div className="flex flex-row justify-center items-center gap-0 h-16 md:h-24 ">
